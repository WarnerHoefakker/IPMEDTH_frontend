...
export default function LC6(props) {
    //{props.colors && props.colors['lc6006'] ? props.colors['lc6006'] : "#e4f8e4"}
    return (
        <Svg
    ...
    >
      ...
      >
        ...
        <G id="lc6010" transform="translate(27.438 458.426)">
          <G id="achtergrond" fill={props.colors && props.colors['lc6010'] ? props.colors['lc6010'] : "#e4f8e4"}>
            <Path
        ...
        <G id="lc6005" transform="translate(84.854 433.238)">
          <G id="achtergrond-2" data-name="achtergrond" fill={props.colors && props.colors['lc6005'] ? props.colors['lc6005'] : "#e4f8e4"}>
            <Path
        ...
        <G id="lc6044" transform="translate(115.63 228.854)">
          <G
            ...
            fill={props.colors && props.colors['lc6044'] ? props.colors['lc6044'] : "#e4f8e4"}
            stroke="#2c2c2c"
            strokeWidth={1}
          >
        ...
        <G id="lc6024" transform="translate(26.854 358.604)">
          <G id="achtergrond-4" data-name="achtergrond" fill={props.colors && props.colors['lc6024'] ? props.colors['lc6024'] : "#e4f8e4"}>
            <Path
        ...
        <G id="lc6050" transform="translate(247.241 358.604)">
          <G
            ...
            fill={props.colors && props.colors['lc6050'] ? props.colors['lc6050'] : "#e4f8e4"}
          >
            <Path
              d="M 89.5 48.15635299682617 L 0.5 48.15635299682617 L 0.5 0.5 L 89.5 0.5 L 89.5 48.15635299682617 Z"
              stroke="none"
        ...
        <G id="lc6025" transform="translate(163.854 310.009)">
          <G id="achtergrond-6" data-name="achtergrond" fill={props.colors && props.colors['lc6025'] ? props.colors['lc6025'] : "#e4f8e4"}>
            <Path
        ...
        <G id="lc6060" transform="translate(278.438 433.238)">
          <G id="achtergrond-7" data-name="achtergrond" fill={props.colors && props.colors['lc6060'] ? props.colors['lc6060'] : "#e4f8e4"}>
            <Path
        ...
        <G id="lc6064" transform="translate(246.854 433.238)">
          <G id="achtergrond-8" data-name="achtergrond" fill={props.colors && props.colors['lc6064'] ? props.colors['lc6064'] : "#e4f8e4"}>
            <Path
